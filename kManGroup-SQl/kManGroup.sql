...
jobBandLevelID int PRIMARY KEY NOT NULL,
competencyStage1 text NOT NULL,
competencyStage2 text NOT NULL,
competencyStage3 text NOT NULL,
competencyStage4 text NOT NULL,

CONSTRAINT fk_jobBandLevelID1 FOREIGN KEY (jobBandLevelID) REFERENCES jobRoles (jobBandLevelID)
);
