...
insert into capabilityLead(leadID, leadFname, leadSname, leadPhoto, leadMessage, jobCapabilityID) values (1,"Dave","Boats","URL","hi i work here",1);
...
competencyStage varchar(20) NOT NULL,
...
CONSTRAINT fk_JobFamilyID foreign key (jobFamilyID) references jobFamilies(jobFamilyID));
...
insert into bandLevels(jobBandLevel) values('Apprentice');
insert into bandLevels(jobBandLevel) values('Trainee');
insert into bandLevels(jobBandLevel) values('Associate');
insert into bandLevels(jobBandLevel) values('Senior Associate');
insert into bandLevels(jobBandLevel) values('Consultant');
...
insert into competenciesData (competencyDataID, competencyStage) values(5,"Behaves in an open, honest, and inclusive manner, upholding personal andorganisational ethics and values. Shows respect for the needs of others and promotes equality and diversity.");
insert into competenciesData (competencyDataID, competencyStage) values(6, "Appreciates the impact of selfon others and the impact others have on self. Routinely seeks feedback and adapts ownbehaviour appropriately. Identifying the impact others have on self and others.Reflects on owninteractions with a wide and diverse range of individuals andgroups from within and beyond immediate service/organisation.Challenges and refreshes own values, beliefs,");
insert into competenciesData (competencyDataID, competencyStage) values(7,"Ensures that own work plans and priorities fit with the needs of others involved in delivering services. Demonstrates flexibility and sensitivity and remainsassertive in pursuing service goals.Builds and managed own personal brand both internally and externally.");
insert into competenciesData (competencyDataID, competencyStage) values(8,"Encouragesa broad range of formal and informallearning opportunities, supporting development andcareer managementby putting selfforward for challenging assignments and projects which will develop strengths and address development areas. Seeks and provides constructive feedback from a variety of sources to support personal growth.");
insert into competenciesData (competencyDataID, competencyStage) values(9,".Acts as a role model for others in demonstrating integrity and inclusiveness in all aspects of ownwork.Challenges where organisational values arecompromised.");
insert into competenciesData (competencyDataID, competencyStage) values(10,"Reflects on owninteractions with a wide and diverse range of individuals andgroups from within and beyond immediate service/organisation.Challenges and refreshes own values, beliefs, leadership styles and approaches. Overtly role models the giving and receiving of feedback.");
insert into competenciesData (competencyDataID, competencyStage) values(11,"Successfully manages a range of personal and organisational demandsand pressures. Demonstrates tenacity and resilience. Overcomes setbackswhere goals cannot be achieved and quickly refocuses. Is visible andaccessible to others.");
insert into competenciesData (competencyDataID, competencyStage) values(12,"Acts as an exemplar for others in managingcontinuous personaldevelopment. Facilitates thedevelopment of a learning culture.Identifies tangible, objective business improvementsand benefits when planning development activitiesand identifiesand tracksthesethrough metrics, to demonstrate impact onbusiness results.");
insert into competenciesData (competencyDataID, competencyStage) values(13,"Creates an open, honest, and inclusive culture in accordance with clearprinciples and values. Ensures equity of access to services and creates anenvironment where people from all backgrounds can excel.");
insert into competenciesData (competencyDataID, competencyStage) values(14,"An exemplary role model of self-awareness and welcomes feedback openly. A strong advocate and voice for building a culture of self-development and seen to set the tone for effective leadership at a senior level.Uses sophisticated tools and sources to continuously learn about ownleadershipimpact across the wider business community and improve personaleffectiveness as a senior leader. Understands how pressures associated with ");
...
insert into competenciesData (competencyDataID, competencyStage) values(16,"Role modelscontinuous learning and self-development, evaluating own effectiveness and growth and planning further development. Progressesin the right direction for self and Kainos through strong personal ownership.");
insert into competenciesData (competencyDataID, competencyStage) values(17,"Assures standards of integrity are maintained across the business and communicates the importance of alwaysadopting an ethical and inclusive approach.");
insert into competenciesData (competencyDataID, competencyStage) values(18, "Uses sophisticated tools and sources to continuously learn about ownleadershipimpact across the wider business community and improve personaleffectiveness as a senior leader. Understands how pressures associated with carrying out a high-profile role impacts personally and own performance.");
insert into competenciesData (competencyDataID, competencyStage) values(19,"Remains focused on the wider Kainos strategic goals when faced with competingand, at times, conflicting demands arising from differing priorities. Identifies where the need to personally get involved to achieve the most benefit for the wider organisation.");
insert into competenciesData (competencyDataID, competencyStage) values(20,"Develops through systematically scanningthe external environment and exploring leading edge thinking and best practice.Applies learning to build and refresh the business. Treats challenge as a positive forcefor improvement.");
...
insert into jobFamilies(jobFamilyName) values('Engineering');
insert into jobFamilies(jobFamilyName) values('Testing and Quality Assurance');
insert into jobFamilies(jobFamilyName) values('Security Engineering');
insert into jobFamilies(jobFamilyName) values('Data Engineering');
insert into jobFamilies(jobFamilyName) values('Integrations');
insert into jobFamilies(jobFamilyName) values('Operational Management');
insert into jobFamilies(jobFamilyName) values('Business Development');
insert into jobFamilies(jobFamilyName) values('Artificial Intelligence (AI) Engineering');
insert into jobFamilies(jobFamilyName) values('Delivery Strategy & Planning');
