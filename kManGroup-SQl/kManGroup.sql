...
competencyStage1 text NOT NULL,
competencyStage2 text NOT NULL,
competencyStage3 text NOT NULL,
competencyStage4 text NOT NULL
);
...
Primary Key(jobBandLevelID,competencyDataID),
CONSTRAINT fk_competencyDataID1 FOREIGN KEY (competencyDataID) REFERENCES competenciesData (competencyDataID),
CONSTRAINT fk_jobBandLevelIDtraining2 FOREIGN KEY (jobBandLevelID) REFERENCES bandLevels(jobBandLevelID));
...
insert into competencies(jobBandLevelID,competencyDataID) Values(7,5);
insert into competencies(jobBandLevelID,competencyDataID) Values(8,5);
