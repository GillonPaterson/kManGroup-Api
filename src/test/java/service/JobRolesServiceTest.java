...
class JobRolesServiceTest {
  ...
  @Test
    void testServiceGetAllCapabilityLeads() throws SQLException {
      ...
      CapabilityDAO capabilityDAO = Mockito.mock(CapabilityDAO.class);
        ...
        JobRolesService jobRolesService = new JobRolesService(capabilityDAO, connector);
        List<CapabilityLead> returnedList = jobRolesService.getAllCapabilityLeads();
  ...
  @Test
    void testServiceGetCapabilityLead() throws SQLException {
        ...
        JobRolesService jobRolesService = new JobRolesService(capabilityDAO, connector);
        CapabilityLead returnedModel = jobRolesService.getCapabilitylead(1);
